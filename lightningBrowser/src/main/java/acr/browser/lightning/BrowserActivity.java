...
public class BrowserActivity extends Activity implements BrowserController {
    ...
    private HorizontalListView mBookmarkBar;
    private HorizontalListView mTabBar;
	...
	private synchronized void initialize() {
		...
		mNewTab = (LinearLayout) findViewById(R.id.new_tab_button);
        ...
        mBookmarkBar = (HorizontalListView) findViewById(R.id.bookmark_list);
        mTabBar = (HorizontalListView) findViewById(R.id.tab_list);
		...
		mActionBar.setCustomView(R.layout.address_bar);
		...
		mCopyIcon.setBounds(0, 0, Utils.convertToDensityPixels(mContext, 24),
				Utils.convertToDensityPixels(mContext, 24));
        //mBookmarkIcon = getResources().getDrawable(R.drawable.ic_bookmark);
        //mBookmarkIcon.setBounds(0, 0, Utils.convertToDensityPixels(mContext, 24),
                //Utils.convertToDensityPixels(mContext, 24));
		mIcon = mRefreshIcon;
		...
		mSearch.setOnFocusChangeListener(new View.OnFocusChangeListener() {
			...
			public void onFocusChange(View v, boolean hasFocus) {
				if (!hasFocus && mCurrentView != null) {
                    ...
                    //mIcon= mBookmarkIcon;
                    //mSearch.setCompoundDrawables(null, null, mBookmarkIcon, null);
					mIcon = mCopyIcon;
		...
		R.drawable.ic_lightning, /* nav drawer image to replace 'Up' caret */
	...
	protected synchronized void newTab(String url, boolean show) {
		mIsNewIntent = false;
		LightningView startingTab = new LightningView(mActivity, url, mContext);
		if (mIdGenerator == 0) {
	...
	public BitmapDrawable writeOnDrawable(int number) {
		...
		Bitmap bm = Bitmap.createBitmap(3, mActionBarSize, Config.ARGB_8888);
		String text = number + "";
